...
.section .text
${x8664programASM.functions.map((func) => func.accept(this)).join("\n")}
...
${function.instrs.map((inst) => inst.accept(this)).join('\n')}""";
  ...
  @override
  String visitAllocateStackX8664Instr(AllocateStackX8664Instr alloc) => 
    "subq \$${alloc.amount}, %rsp";
...
ret""";
  ...
  @override
  String visitCallX8664Instr(CallX8664Instr callX8664Instr) => 
    "call ${callX8664Instr.identifier}@PLT";
  
  @override
  String visitDeallocateStackX8664Instr(DeallocateStackX8664Instr deallocateStackX8664Instr) => 
    "addq \$${deallocateStackX8664Instr.amount}, %rsp";
  
  @override
  String visitPushX8664Instr(PushX8664Instr pushX8664Instr) =>
    "pushq ${pushX8664Instr.operand.accept(this)}";
    
  @override
  String visitCommentX8664Instr(CommentX8664Instr commentX8664Instr) => 
    "// ${commentX8664Instr.msg}";
}